...
Architecture decision 7개가 채택됐다. G-CUT3R는 offline teacher로 제한하고,
...
들어간다. Student delivery는 model-free contract와 승인된 remote all-rank load
consensus를 별도 trust gate로 사용한다.
...
| [ADR-0007](adr-0007-model-boundary-contract-and-load-gate.md) | Immutable boundary contract와 physical all-rank load gate | Local implementation | Provider lock·remote conformance 승인 |
