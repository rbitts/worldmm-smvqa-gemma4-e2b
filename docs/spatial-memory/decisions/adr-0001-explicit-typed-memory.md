# ADR-0001: Store persistent spatial memory as explicit typed records

| Metadata | Value |
|---|---|
| Page ID | SM-ADR-0001 |
| ADR | ADR-0001 |
| Project claims | C-002, C-006, C-012 |
| Status | Accepted; partially implemented |
| Date | 2026-07-11 |
| Traceability | [Explicit and queryable memory requirements](../traceability.md) |
| Architecture | [Typed persistent memory](../architecture.md) |
