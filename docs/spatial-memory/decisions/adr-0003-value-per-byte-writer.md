# ADR-0003: Persistent record를 actual serialized byte당 value로 선택
...
| 상태 | 채택; 일부 구현 |
| 결정일 | 2026-07-11 |
| 추적성 | [Bounded storage와 QA utility 요구사항](../traceability.md) |
| 아키텍처 | [Budgeted memory writer](../architecture.md) |
