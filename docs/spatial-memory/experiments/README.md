...
plumbing만 검증한다. 필요한 evidence 순서는 sensor/provider audit,
teacher-oracle object/location ceiling, 최소 hybrid student, matched E1/E2/E3,
byte-Pareto다.
...
| [EXP-0005](exp-0005-teacher-oracle-ceiling.md) | Causal teacher-oracle object/location ceiling | Local contract만 구현 | Student 전 즉시 검증 대상 |
| [EXP-0002](exp-0002-typed-memory-bridge.md) | Minimal hybrid student bridge | Legacy candidate-head contract만 구현 | EXP-0005 Go 이후 재설계·실행 |
