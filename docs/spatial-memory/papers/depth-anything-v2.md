...
| 출판 | NeurIPS 2024, Main Conference Track |
| 1차 출처 | [Official NeurIPS paper record](https://proceedings.neurips.cc/paper_files/paper/2024/hash/26cfdcd8fe6fd75cc53e92963a656c58-Abstract-Conference.html) |
| 공식 code | [DepthAnything/Depth-Anything-V2](https://github.com/DepthAnything/Depth-Anything-V2) |
| 최종 확인 | 2026-07-11 |
| 프로젝트 연결 | [논문 목록](README.md), [아키텍처](../architecture.md), [로드맵](../roadmap.md) |
...
- [공식 project page](https://depth-anything-v2.github.io/)
- [공식 code](https://github.com/DepthAnything/Depth-Anything-V2)
- [공식 arXiv record](https://arxiv.org/abs/2406.09414)
