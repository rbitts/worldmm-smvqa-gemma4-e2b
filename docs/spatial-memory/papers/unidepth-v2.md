...
| 출판 | IEEE Transactions on Pattern Analysis and Machine Intelligence, 48(3), 2026, pp. 2354–2367 |
| 1차 출처 | [공식 DOI](https://doi.org/10.1109/TPAMI.2025.3628473) |
| 공식 code | [lpiccinelli-eth/UniDepth](https://github.com/lpiccinelli-eth/UniDepth) |
| 최종 확인 | 2026-07-11 |
...
- [공식 DOI](https://doi.org/10.1109/TPAMI.2025.3628473)
- [Official arXiv record, version 2](https://arxiv.org/abs/2502.20110)
- [공식 code와 model 문서](https://github.com/lpiccinelli-eth/UniDepth)
