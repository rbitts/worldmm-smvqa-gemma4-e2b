...
| 상태 | 검토 완료 |
| Method 명칭 | DART: Duplication-Aware Reduction of Tokens |
| 저자 | Zichen Wen, Yifeng Gao, Shaobo Wang, Junyuan Zhang, Qintong Zhang, Weijia Li, Conghui He, Linfeng Zhang |
| 출판 | EMNLP 2025 main, pages 9961-9980 |
| 확인 version | arXiv:2502.11494v2, 2025-06-08 |
| 1차 출처 | [ACL Anthology](https://aclanthology.org/2025.emnlp-main.505/) · [arXiv](https://arxiv.org/abs/2502.11494) |
| 공식 code | [ZichenWen1/DART](https://github.com/ZichenWen1/DART) |
| 최종 확인 | 2026-07-11 |
...
- [공식 code](https://github.com/ZichenWen1/DART)
